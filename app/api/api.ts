...
// Helper function để normalize dữ liệu từ MongoDB
// Đảm bảo tất cả ID đều có format nhất quán (id thay vì _id)
function normalizeMongoData(data: any): any {
  ...
  if (data && typeof data === 'object') {
    ...
    if (normalized._id && !normalized.uid && (normalized.username || normalized.email)) {
